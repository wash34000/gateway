...
class WebInterface:
    ...
    ###### TODO Here comes the autogenerated configuration api
    ...
    def get_input_configuration(self, token, id):
        ...
        :type id: Id
        :returns: 'config': input_configuration dict: contains 'id' (Id), 'action' (Byte), 'basic_actions' (Actions(15)), 'name' (String(8))
        """
        self.__check_token(token)
    ...
    def get_input_configurations(self, token):
        ...
        :returns: 'config': list of input_configuration dict: contains 'id' (Id), 'action' (Byte), 'basic_actions' (Actions(15)), 'name' (String(8))
        """
        self.__check_token(token)
