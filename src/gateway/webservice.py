...
class WebInterface:
    ...
    @cherrypy.expose
    def get_output_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_output_configuration(int(id)))
    ...
    @cherrypy.expose
    def get_input_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_input_configuration(int(id)))
    
    @cherrypy.expose
    def get_input_configurations(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_input_configurations())
    ...
    @cherrypy.expose
    def get_thermostat_configuration(self, token, id):
        """
        Get a specific thermostat_configuration defined by its id.
        :param id: The id of the thermostat_configuration
        :type id: Id
        :returns: 'config': thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_thermostat_configuration(int(id)))
    
    @cherrypy.expose
    def get_thermostat_configurations(self, token):
        """
        Get all thermostat_configurations.
        :returns: 'config': list of thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_thermostat_configurations())
    ...
    def set_thermostat_configuration(self, token, config):
        ...
        :type config: thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        self.__check_token(token)
    ...
    def set_thermostat_configurations(self, token, config):
        ...
        :type config: list of thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        self.__check_token(token)
    ...
    @cherrypy.expose
    def get_sensor_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_sensor_configuration(int(id)))
    
    @cherrypy.expose
    def get_sensor_configurations(self, token):
        """
        Get all sensor_configurations.
        :returns: 'config': list of sensor_configuration dict: contains 'id' (Id), 'name' (String[16])
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_sensor_configurations())
    ...
    @cherrypy.expose
    def get_pump_group_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_pump_group_configuration(int(id)))
    
    @cherrypy.expose
    def get_pump_group_configurations(self, token):
        """
        Get all pump_group_configurations.
        :returns: 'config': list of pump_group_configuration dict: contains 'id' (Id), 'outputs' (CSV[32])
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_pump_group_configurations())
    ...
    @cherrypy.expose
    def get_group_action_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_group_action_configuration(int(id)))
    
    @cherrypy.expose
    def get_group_action_configurations(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_group_action_configurations())
    ...
    @cherrypy.expose
    def get_scheduled_action_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_scheduled_action_configuration(int(id)))
    
    @cherrypy.expose
    def get_scheduled_action_configurations(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_scheduled_action_configurations())
    ...
    @cherrypy.expose
    def get_pulse_counter_configuration(self, token, id):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_pulse_counter_configuration(int(id)))
    
    @cherrypy.expose
    def get_pulse_counter_configurations(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_pulse_counter_configurations())
    ...
    @cherrypy.expose
    def get_startup_action_configuration(self, token):
        """
        Get the startup_action_configuration.
        :returns: 'config': startup_action_configuration dict: contains 'actions' (Actions[100])
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_startup_action_configuration())
    ...
    @cherrypy.expose
    def get_dimmer_configuration(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_dimmer_configuration())
    ...
    @cherrypy.expose
    def get_global_thermostat_configuration(self, token):
        """
        ...
        """
        self.__check_token(token)
        return self.__success(config=self.__gateway_api.get_global_thermostat_configuration())
