...
class GatewayApi:
    ...
    def get_output_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(OutputConfiguration, id).to_dict()
    ...
    def get_output_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(OutputConfiguration) ]
    ...
    def get_input_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(InputConfiguration, id).to_dict()
    ...
    def get_input_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(InputConfiguration) ]
    ...
    def get_thermostat_configuration(self, id):
        ...
        :type id: Id
        :returns: thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        return self.__eeprom_controller.read(ThermostatConfiguration, id).to_dict()
    
    def get_thermostat_configurations(self):
        """
        Get all thermostat_configurations.
        :returns: list of thermostat_configuration dict: contains 'id' (Id), 'name' (String[16]), 'output0' (Byte), 'output1' (Byte), 'pid_d' (Byte), 'pid_i' (Byte), 'pid_int' (Byte), 'pid_p' (Byte), 'sensor' (Temp), 'setp0' (Temp), 'setp1' (Temp), 'setp2' (Temp), 'setp3' (Temp), 'setp4' (Temp), 'setp5' (Temp)
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(ThermostatConfiguration) ]
    ...
    def get_sensor_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(SensorConfiguration, id).to_dict()
    ...
    def get_sensor_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(SensorConfiguration) ]
    ...
    def get_pump_group_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(PumpGroupConfiguration, id).to_dict()
    ...
    def get_pump_group_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(PumpGroupConfiguration) ]
    ...
    def get_group_action_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(GroupActionConfiguration, id).to_dict()
    ...
    def get_group_action_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(GroupActionConfiguration) ]
    ...
    def get_scheduled_action_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(ScheduledActionConfiguration, id).to_dict()
    ...
    def get_scheduled_action_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(ScheduledActionConfiguration) ]
    ...
    def get_pulse_counter_configuration(self, id):
        ...
        """
        return self.__eeprom_controller.read(PulseCounterConfiguration, id).to_dict()
    ...
    def get_pulse_counter_configurations(self):
        ...
        """
        return [ o.to_dict() for o in self.__eeprom_controller.read_all(PulseCounterConfiguration) ]
    ...
    def get_startup_action_configuration(self):
        ...
        """
        return self.__eeprom_controller.read(StartupActionConfiguration).to_dict()
    ...
    def get_dimmer_configuration(self):
        ...
        """
        return self.__eeprom_controller.read(DimmerConfiguration).to_dict()
    ...
    def get_global_thermostat_configuration(self):
        ...
        """
        return self.__eeprom_controller.read(GlobalThermostatConfiguration).to_dict()
