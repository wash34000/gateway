...
from master.eeprom_models import InputConfiguration, GlobalThermostatConfiguration
...
class GatewayApi:
    ...
    ###### TODO Here come the autogenerated maste configuration functions
    ...
    def get_input_configuration(self, id):
        ...
        :type id: Id
        :returns: input_configuration dict: contains 'id' (Id), 'action' (Byte), 'basic_actions' (Actions(15)), 'name' (String(8))
        """
    ...
    def get_input_configurations(self):
        ...
        :returns: list of input_configuration dict: contains 'id' (Id), 'action' (Byte), 'basic_actions' (Actions(15)), 'name' (String(8))
        """
